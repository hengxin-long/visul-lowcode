<template>
  ...
  <!-- 预览窗口 -->
  <DesignPreviewForm
    :isPreviewFormVisible="isPreviewFormVisible"
    @close="closePreviewForm"
  />
  <!-- 保存窗口 -->
  <el-dialog
    v-model="isSaveFormVisible"
    title="保存表单"
    width="500"
    :before-close="closeSaveForm"
  >
    <span>是否保存为草稿？</span>
    <template #footer>
      <div class="dialog-footer">
        ...
        <el-button
          ...
          >不保存</el-button
        >
        <el-button @click="handleForm('draft')"> 是 </el-button>
        <el-button
          @click="handleForm('published')"
          type="primary"
          >发布</el-button
